...
This repo deploys as the `docs-peagen-com` self-hosted Docker service. DNS is managed through the PyPI `npmctl-namecheap` provider for the `peagen.com` zone and is declared in `desired-state/dns.yaml`.
